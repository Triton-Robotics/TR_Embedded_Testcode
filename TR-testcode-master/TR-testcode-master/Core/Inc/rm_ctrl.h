...
#define TEMPERATURE_PID_MAX_OUT 4900.0f  //max out of temperature control PID
#define TEMPERATURE_PID_MAX_IOUT 4400.0f //max iout of temperature control PID

#define DESIRED_TEMPERATURE 50.0f // desired temperature for IMU
...
extern float yaw_imu_deg_ctrl(float feedback, float target);

extern float yaw_imu_dps_ctrl(float feedback, float target);
